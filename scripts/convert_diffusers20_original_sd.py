################################################################
# FILE COPIED FROM : https://note.com/kohya_ss/n/n374f316fe4ad
# Refer to the link above for license terms (v4)
# Example:
# python convert_diffusers20_original_sd.py ./diff-users-folder ./output.safetensors --v2 --reference_model stabilityai/stable-diffusion-2-1
################################################################
